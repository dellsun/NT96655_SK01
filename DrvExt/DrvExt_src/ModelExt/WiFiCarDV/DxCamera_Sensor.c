...
SENSOR_INIT_OBJ DrvSensor_GetObj1st(void)
{
    ...
    //reset
    debug_msg("^G DrvSensor_GetObj1st   clear  sensorreset \r\n");
    gpio_clearPin(GPIO_SENSOR_RESET);
    Delay_DelayMs(100);
    debug_msg("^G DrvSensor_GetObj1st   set  sensorreset \r\n");
    gpio_setPin(GPIO_SENSOR_RESET);
    Delay_DelayMs(100);
    return InitObj;
}
...
//    gpio_setDir(GPIO_SENSOR_STANDBY, GPIO_DIR_OUTPUT);
  //  gpio_setPin(GPIO_SENSOR_STANDBY);
debug_msg("^G DrvSensor_TurnOnPower   set  sensorreset \r\n");
    gpio_setDir(GPIO_SENSOR_RESET, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_RESET);
}
#endif
...
void DrvSensor_TurnOffPower(void)
{
    ...
    debug_msg("^G DrvSensor_TurnOffPower  1   set  sensorreset \r\n");
    gpio_clearPin(GPIO_SENSOR_RESET);
  //  gpio_clearPin(GPIO_SENSOR_STANDBY);
}
#endif
...
//    gpio_setDir(GPIO_SENSOR_STANDBY, GPIO_DIR_OUTPUT);
//    gpio_setPin(GPIO_SENSOR_STANDBY);
    debug_msg("^G DrvSensor_TurnOffPower  2   set  sensorreset \r\n");
    gpio_setDir(GPIO_SENSOR_RESET, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_RESET);
}
#endif
...
void DrvSensor_PowerSaveOn(void)
{
    debug_msg("^G DrvSensor_PowerSaveOn  1   clear  sensorreset \r\n");
    gpio_clearPin(GPIO_SENSOR_RESET);
//    gpio_clearPin(GPIO_SENSOR_STANDBY);
}
#endif
