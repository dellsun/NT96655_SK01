...
//#NT#2012/12/17#HH Chuang -end
{
        ...
        gpio_setDir(P_GPIO_39, GPIO_DIR_OUTPUT);  //This is a sample. refer to real schematic circuit
    
        switch(uiCnt % 9)
        {
          case 0:
              gpio_setPin(P_GPIO_39);  //This is a sample. refer to real schematic circuit
              break;
          case 5:
              gpio_clearPin(P_GPIO_39); //This is a sample. refer to real schematic circuit
              break;
        }
        uiCnt++;
    #else
        static UINT32 uiCnt = 0;
            // set LED GPIO output direction
            gpio_setDir(C_GPIO_13, GPIO_DIR_OUTPUT);  //This is a sample. refer to real schematic circuit
        
            switch(uiCnt % 9)
            {
              case 0:
                  gpio_setPin(C_GPIO_13);  //This is a sample. refer to real schematic circuit
                  break;
              case 5:
                  gpio_clearPin(C_GPIO_13); //This is a sample. refer to real schematic circuit
                  break;
            }
            uiCnt++;
