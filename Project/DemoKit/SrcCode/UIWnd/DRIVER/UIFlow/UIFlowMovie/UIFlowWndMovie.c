...
INT32 UIFlowWndMovie_OnMovieOneSec(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    case MOV_ST_REC|MOV_ST_ZOOM:
		...
		//if(LED_IsLEDOn(KEYSCAN_LED_FCS))
		//LED_TurnOffLED(KEYSCAN_LED_FCS);// GxLED_SetCtrl(KEYSCAN_LED_FCS,TURNON_LED,FALSE);
		//else
		//LED_TurnOnLED(KEYSCAN_LED_FCS);	
        if (paramNum)
        {
