...
*/
#ifndef _AE_OV2710_EVB_FF_INT_H_
#define _AE_OV2710_EVB_FF_INT_H_
...
#define AE_EXPECT_Y                 (32<<4)//(30<<4)                     ///< expectY
#define AE_MAX_ISO                  500                         ///< max iso
...
#define AE_EXPECT_Y_NIGHT           (8<<4)                     ///< expect Y night
#define AE_ADJ_EXPECT_Y_EV_U        (((1<<8) + (1<<7)) * 10)     ///< adjust expect Y, upper EV
#define AE_ADJ_EXPECT_Y_EV_L        ((1<<7) * 10)               ///< adjust expect Y, lower EV
